...
int main()
{
    ...
    printf("\n Hello %s, I am Jarvis, Your personal Chatbot.\n Ask me something...\n", name);
    printf(" Type the keywords 'google' and 'search' to search anything on google and 'youtube' to search on youtube.\n ");
    printf("For example: 'search computer' searches the word 'computer on google.'\n");
